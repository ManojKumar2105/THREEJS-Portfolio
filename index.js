...
import * as gsap from 'https://cdn.jsdelivr.net/npm/gsap@3.10.4/index.js'

const parameters = {
    color: 0xff0000,
    spin: () =>
    {
        gsap.gsap.to(mesh.rotation, 1, { y: mesh.rotation.y + Math.PI * 2 })
    }
}
...
const particle=textureloader.load('./5.png')
...
const tick = () =>
{
    ...
    gsap.gsap.to(camera.position,{duration:1,delay:1,z:5})
    // Update controls
    controls.update()
